...
if [ -n "$(grep '^dtoverlay=vc4-kms-v3d' '/boot/firmware/config.txt')" ]
then
...
display "debug 5"
sudo apt -y install libkf5xmlgui-dev kio kinit-dev libkf5newstuff-dev kdoctools5 libkf5doctools-dev libkf5notifications-dev libqt5websockets5-dev qtdeclarative5-dev libkf5crash-dev gettext qml-module-qtquick-controls qml-module-qtquick-layouts
display "debug 6"
